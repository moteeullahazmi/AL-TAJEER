...
const Navbar = () => {
  ...
  return (
    ...
    <a href="https://admin.altajeer.in/" target="_blank" className="border px-5 text-xs py-1 rounded-full -mt-2"><p className="mt-1">Admin Panel</p></a>
    </ul>
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
          ...
          <div className='flex flex-col text-gray-600'>
            <div onClick={()=>setVisible(false)} className='flex items-center gap-4 p-3 cursor-pointer'>
              <img className='h-4 rotate-180' src={assets.dropdown_icon} alt='drop-down'/>
                <p>Back</p>
            </div>
